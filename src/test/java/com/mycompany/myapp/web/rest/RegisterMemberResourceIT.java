...
import com.mycompany.myapp.NewRegisterFormApp;
 ...
 */
@SpringBootTest(classes = NewRegisterFormApp.class)
public class RegisterMemberResourceIT {
    ...
    private static final Province DEFAULT_PROVINCE = Province.Alberta;
    private static final Province UPDATED_PROVINCE = Province.BritishColumbia;
    ...
    private static final ImmigrationStatus DEFAULT_IMMIGRATION_STATUS = ImmigrationStatus.Citizen;
    private static final ImmigrationStatus UPDATED_IMMIGRATION_STATUS = ImmigrationStatus.PermanentResidence;

    private static final Baptism DEFAULT_BAPTISM_TYPE = Baptism.None;
    private static final Baptism UPDATED_BAPTISM_TYPE = Baptism.InfantBaptism;
    ...
    private static final DutyStatus DEFAULT_DUTY_STATUS = DutyStatus.None;
    private static final DutyStatus UPDATED_DUTY_STATUS = DutyStatus.GeneralServant;
    ...
    private static final Volunteer DEFAULT_VOLUNTEER = Volunteer.FrontDesk;
    private static final Volunteer UPDATED_VOLUNTEER = Volunteer.Choir;
    ...
    public void createRegisterMember() throws Exception {
        ...
        assertThat(testRegisterMember.getImmigrationStatus()).isEqualTo(DEFAULT_IMMIGRATION_STATUS);
        assertThat(testRegisterMember.getBaptismType()).isEqualTo(DEFAULT_BAPTISM_TYPE);
        assertThat(testRegisterMember.getBaptismYear()).isEqualTo(DEFAULT_BAPTISM_YEAR);
        assertThat(testRegisterMember.getBaptismChurch()).isEqualTo(DEFAULT_BAPTISM_CHURCH);
        ...
        assertThat(testRegisterMember.getVolunteer()).isEqualTo(DEFAULT_VOLUNTEER);
    }
    ...
    @Test
    @Transactional
    public void checkImmigrationStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = registerMemberRepository.findAll().size();
        // set the field null
        registerMember.setImmigrationStatus(null);
    ...
    public void getAllRegisterMembers() throws Exception {
        ...
        restRegisterMemberMockMvc.perform(get("/api/register-members?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].immigrationStatus").value(hasItem(DEFAULT_IMMIGRATION_STATUS.toString())))
    ...
    public void getRegisterMember() throws Exception {
        ...
        restRegisterMemberMockMvc.perform(get("/api/register-members/{id}", registerMember.getId()))
            ...
            .andExpect(jsonPath("$.immigrationStatus").value(DEFAULT_IMMIGRATION_STATUS.toString()))
    ...
    public void updateRegisterMember() throws Exception {
        ...
        assertThat(testRegisterMember.getImmigrationStatus()).isEqualTo(UPDATED_IMMIGRATION_STATUS);
        assertThat(testRegisterMember.getBaptismType()).isEqualTo(UPDATED_BAPTISM_TYPE);
        assertThat(testRegisterMember.getBaptismYear()).isEqualTo(UPDATED_BAPTISM_YEAR);
        assertThat(testRegisterMember.getBaptismChurch()).isEqualTo(UPDATED_BAPTISM_CHURCH);
        ...
        assertThat(testRegisterMember.getVolunteer()).isEqualTo(UPDATED_VOLUNTEER);
    }
