...
describe('FamilyMember e2e test', () => {
  ...
  it('should load create FamilyMember page', async () => {
    ...
    expect(await familyMemberUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /newRegisterFormApp.familyMember.home.createOrEditLabel/
    );
  ...
  it('should create and save FamilyMembers', async () => {
    async function createFamilyMember() {
      ...
      await familyMemberUpdatePage.genderSelectLastOption();
      ...
      await familyMemberUpdatePage.dutyStatusSelectLastOption();
      ...
      await familyMemberUpdatePage.volunteerSelectLastOption();
  ...
  it('should delete last FamilyMember', async () => {
    ...
    expect(await familyMemberDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newRegisterFormApp.familyMember.delete.question/);
