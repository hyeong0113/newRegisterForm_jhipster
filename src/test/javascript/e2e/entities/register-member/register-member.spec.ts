...
describe('RegisterMember e2e test', () => {
  ...
  it('should load create RegisterMember page', async () => {
    ...
    expect(await registerMemberUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /newRegisterFormApp.registerMember.home.createOrEditLabel/
    );
  ...
  it('should create and save RegisterMembers', async () => {
    async function createRegisterMember() {
      ...
      await registerMemberUpdatePage.genderSelectLastOption();
      ...
      await registerMemberUpdatePage.provinceSelectLastOption();
      ...
      await registerMemberUpdatePage.immigrationStatusSelectLastOption();
      await registerMemberUpdatePage.baptismTypeSelectLastOption();
      await registerMemberUpdatePage.setBaptismYearInput('baptismYear');
      expect(await registerMemberUpdatePage.getBaptismYearInput()).to.match(/baptismYear/);
      await registerMemberUpdatePage.setBaptismChurchInput('baptismChurch');
      expect(await registerMemberUpdatePage.getBaptismChurchInput()).to.match(/baptismChurch/);
      await registerMemberUpdatePage.dutyStatusSelectLastOption();
      ...
      await registerMemberUpdatePage.volunteerSelectLastOption();
  ...
  it('should delete last RegisterMember', async () => {
    ...
    expect(await registerMemberDeleteDialog.getDialogTitle().getAttribute('id')).to.match(
      /newRegisterFormApp.registerMember.delete.question/
    );
