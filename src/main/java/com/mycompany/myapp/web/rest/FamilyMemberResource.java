...
public class FamilyMemberResource {
    ...
    public ResponseEntity<List<FamilyMember>> getAllFamilyMembers(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of FamilyMembers");
        Page<FamilyMember> page = familyMemberRepository.findAll(pageable);
