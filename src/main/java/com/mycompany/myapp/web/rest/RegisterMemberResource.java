...
public class RegisterMemberResource {
    ...
    public ResponseEntity<List<RegisterMember>> getAllRegisterMembers(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of RegisterMembers");
        Page<RegisterMember> page = registerMemberRepository.findAll(pageable);
    ...
    public ResponseEntity<RegisterMember> getRegisterMember(@PathVariable Long id) {
        ...
        Optional<RegisterMember> registerMember = registerMemberRepository.findById(id);
