    ...
    return (
      <div>
        <h2 id="family-member-heading">
          <Translate contentKey="newRegisterFormApp.familyMember.home.title">Family Members</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="newRegisterFormApp.familyMember.home.createLabel">Create new Family Member</Translate>
          </Link>
        </h2>
          ...
          >
            {familyMemberList && familyMemberList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('korName')}>
                      <Translate contentKey="newRegisterFormApp.familyMember.korName">Kor Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('engName')}>
                      <Translate contentKey="newRegisterFormApp.familyMember.engName">Eng Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('birthday')}>
                      <Translate contentKey="newRegisterFormApp.familyMember.birthday">Birthday</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('gender')}>
                      <Translate contentKey="newRegisterFormApp.familyMember.gender">Gender</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                ...
                <tbody>
                  {familyMemberList.map((familyMember, i) => (
                    <tr key={`entity-${i}`}>
                      ...
                      <td>
                        <Translate contentKey={`newRegisterFormApp.Gender.${familyMember.gender}`} />
                      </td>
                      ...
                      <td>
                        <Translate contentKey={`newRegisterFormApp.DutyStatus.${familyMember.dutyStatus}`} />
                      </td>
                      <td>{familyMember.prevChurch}</td>
                      <td>
                        <Translate contentKey={`newRegisterFormApp.Volunteer.${familyMember.volunteer}`} />
                      </td>
                      <td>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="newRegisterFormApp.familyMember.home.notFound">No Family Members found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
